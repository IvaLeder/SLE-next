  ...
  return (
    <>
      ...
      <main id="main-content" className="max-w-3xl mx-auto px-4 py-10 prose prose-lg">
        ...
        <p className="lead">
          This privacy policy applies to <strong>stemlittleexplorers.com</strong>.
        </p>
        ...
        <p>
          ...
          to enter your name, email address, mailing address or other details to help
        ...
        <p>
          ...
          a newsletter, respond to a survey, fill out a form, enter information on our
          site, or provide us with feedback on our products or services.
        </p>
        ...
        <p>
          ...
          numbers or share any data with third-party services.
        </p>

        <h2>Do we use &lsquo;cookies&rsquo;?</h2>
        <p>
          Yes. Cookies are small files that a site or its service provider transfers
          to your computer&rsquo;s hard drive through your web browser (if you allow)
          ...
          cookies to help us understand your preferences based on previous or current
        ...
        <p>
          ...
          also release information when its release is appropriate to comply with the
          law, enforce our site policies, or protect ours or others&rsquo; rights,
          property or safety.
        </p>
        <p>
        ...
        <p>
          ...
          <a
            ...
            rel="noreferrer"
          >
            Google&rsquo;s Advertising Principles
          </a>
          . They are put in place to provide a positive experience for users.
        </p>
        <p>
          We use Google AdSense Advertising on our website. Google, as a third-party
          vendor, uses cookies to serve ads on our site. Google&rsquo;s use of the
        ...
        <p>
          ...
          advertises to them using the Google Ad Settings page. Alternatively, you can
          opt out by visiting the Network Advertising Initiative Opt Out page, or by
        ...
        <p>
          ...
          and online services to post a privacy policy. The law&rsquo;s reach
        ...
        <ul>
          ...
          <li>You can change your personal information by contacting us.</li>
        </ul>
        ...
        <p>
          ...
          the age of 13 years old, the Children&rsquo;s Online Privacy Protection Act
          (COPPA) puts parents in control. The Federal Trade Commission, the United
          States&rsquo; consumer protection agency, enforces the COPPA Rule, which
          spells out what operators of websites and online services must do to protect
          children&rsquo;s privacy and safety online.
        </p>
        ...
        <p className="text-gray-500 text-sm">Last edited on 2017-08-11.</p>
        <p>
