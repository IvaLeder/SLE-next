...
const COPY = {
  en: {
    ...
    note: "International Morse covers A–Z, 0–9 and punctuation. Croatian accents (č, š, ž…) are sent as their base letters because Morse has no separate codes for them.",
    placeholder: " ",
    placeholderMorse: "... --- ...",
  },
  hr: {
    ...
    note: "Međunarodni Morseov kod pokriva A–Ž (bez kvačica), 0–9 i interpunkciju. Hrvatska slova s kvačicama (č, š, ž…) šalju se kao osnovna slova jer Morse za njih nema zasebne kodove.",
    placeholder: " ",
    placeholderMorse: "... --- ...",
  },
} as const;
