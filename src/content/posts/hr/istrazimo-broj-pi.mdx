...
<ActivityInfo age="8+" time="20 min" difficulty="Srednje" mess="Malen" supervision="no" />

<Callout type="tip" title="🥧 Isprobajte dok čitate">Ovaj vodič sadrži pretragu broja pi  - pomaknite se niže i pronađite svoj rođendan skriven u znamenkama. Želite cijelu stranicu? Otvorite [alat Pronađi rođendan u piju](/hr/alati/pronadi-rodendan-u-piju).</Callout>
...
![Istražimo Misteriozan Broj Pi (π) - Arhimedov Pi](/images/posts/Istražimo-Misteriozan-Broj-Pi-Arhimedov-Pi.jpg)
...
![Pi je iracionalan broj](/images/posts/Istražimo-Misteriozan-Broj-Pi-Pi-je-iracionalan-broj.jpg)
...
![Istražimo Misteriozan Broj Pi (π) - Potrebni materijali](/images/posts/Istražimo-Misteriozan-Broj-Pi-Potrebni-materijali.jpg)
...
<PredictionOption correct="true">Uvijek oko 3.14  - isto za svaki krug</PredictionOption>
<PredictionOption>Uvijek točno 3</PredictionOption>
<PredictionResult>
Uvijek je **oko 3.14**  - to je pi! Opseg svakog kruga malo je veći od tri puta njegova promjera, bez obzira na veličinu. Upravo taj nepromjenjivi omjer čini pi tako posebnim.
</PredictionResult>
</Prediction>
...
![Pi je istražen](/images/posts/Istražimo-Misteriozan-Broj-Pi-Pi-je-istražen.jpg)
...
<KeyTakeaways>
- **Pi (π)** je omjer opsega bilo kojeg kruga i njegova promjera  - uvijek oko 3.14.
- Taj je omjer isti za svaki krug, velik ili malen, zbog čega je pi **konstanta**.
- Pi je **iracionalan broj**: njegove znamenke idu u nedogled bez ponavljanja.
- Antički matematičari poput **Arhimeda** procjenjivali su pi pomoću poligona; danas računala znaju trilijune znamenki.
- Pi je neophodan gdje god se pojavljuju krugovi i kugle  - od geometrije do NASA-inih svemirskih misija.
</KeyTakeaways>
...
Zato što svaki krug ima isti oblik, samo povećan ili smanjen. Opseg je uvijek malo veći od tri puta promjera pa dijeljenje jednog s drugim uvijek daje isti broj  - pi.
</Question>
