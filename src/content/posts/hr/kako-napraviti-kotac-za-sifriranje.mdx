---
title: "Kotač za šifriranje: tajne poruke (besplatni predložak)"
translationKey: how-to-make-cipher-wheel
slug: kako-napraviti-kotac-za-sifriranje
lang: hr
subtitle: >-
  Jeste li ikada poželjeli nekome prenijeti poruku koju će samo ta osoba
  razumjeti? Umjesto da osmišljavate vlastiti jezik, postoji i jednostavniji
  način. Kotač za šifriranje! Kodirate poruku koju će moći dekodirati jedino
  osoba za koju to želite. Saznajte kako možete napraviti vlastiti kotač za
  šifriranje i budite tajnoviti.
description: >-
  Napravite kotač za šifriranje i pišite tajne poruke: besplatni predložak za
  ispis (PDF) s hrvatskom abecedom od 30 slova te upute korak po korak.
date: '2020-08-01'
dateModified: '2026-07-05'
author: Vedran Leder
coverImage: /images/posts/Kako-napraviti-Kotac-za-Sifriranje.jpg
heroAlt: "Kotač za šifriranje"
categories:
  - Inženjerstvo
tags:
  - activity
...
<Callout type="tip" title="🔐 Isprobajte i naš alat za šifriranje">Niže u tekstu možete pronaći digitalni alat za šifriranje po uzoru na Cezara. Želite cijelu stranicu? Otvorite [alat Cezarova šifra](/hr/alati/cezarova-sifra).</Callout>

<Printable lang="hr" href="/downloads/kotac-za-sifriranje-predlozak.pdf" title="Predložak kotača za šifriranje" pages="2" size="148 KB">
Dva kotača za izrezivanje s uputama za sastavljanje i šifriranje - s punom hrvatskom abecedom od 30 slova, uključujući DŽ, LJ i NJ.
</Printable>
...
<Figure src="/images/posts/Cezarov-sifrarnik-ili-kotac-za-sifriranje.jpg" alt="Starinski mjedeni Cezarov šifrarnik s rotirajućim abecednim prstenovima" width="600" height="428">
...
<Figure src="/images/posts/cipher-asymmetric-encryption-hr.png" alt="Dijagram asimetričnog šifriranja: pošiljatelj šifrira poruku javnim ključem, a primatelj je dešifrira privatnim ključem" width="1500" height="1000">
...
**Isprobajte odmah!** Upišite poruku, odaberite pomak (ključ) i gledajte kako se pretvara u tajni kod:

<CaesarCipher />

## Potrebni materijali za napraviti Kotač za Šifriranje

<Figure src="/images/posts/Potrebni-materijali-za-napraviti-Kotac-za-Sifriranje.jpg" alt="Materijali za kotač za šifriranje: karton, škare, pribadača, ravnalo i flomasteri" width="600" height="428">
...
<Figure src="/images/posts/Izrada-Cezarovog-kotaca-za-sifriranje.jpg" alt="Dva kartonska kruga podijeljena na polja za slova" width="600" height="428">
  Naš šifrarnik u izradi: oba kartonska kruga podijeljena na polja, po jedno za svako slovo.
</Figure>
...
<Figure src="/images/posts/cipher-caesar-shift-hr.png" alt="Poruka napadusvitanje šifrirana pomicanjem svakog slova za dva mjesta" width="1500" height="1000">
...
- Pratite ideju zajedničkog koda od dimnih signala i Morseove abecede do binarnog koda i interneta u našoj [povijesti komunikacije za djecu](/hr/povijest-komunikacije-za-djecu).
- [**Kako napraviti i riješiti Hanoi toranj**](/hr/kako-napraviti-rijesiti-hanoi-toranj) za odličnu logičku mozgalicu koja može biti lagana ili teška koliko to vi želite.
-  [**Istražimo misteriozni Broj Pi (π)**](/hr/istrazimo-broj-pi) kako bi naučili o ovom zanimljivom broju i vidjeli kako ga na jednostavan način možete demonstrirati.
- [**Zabavne Aktivnosti s Nizovima**](/hr/zabavne-aktivnosti-s-nizovima) za vježbanje logičkih vještine uz aktivnost koja je pogodna i za najmlađu publiku.
- [**Kako napraviti Sat od Kartona i pomoću njega Učiti na Sat**](/hr/kako-napraviti-sat-od-kartona-pomocu-njega-uciti-na-sat) je odlična aktivnost za učenje djece o vremenu, satu i kako saznati vrijeme, na zabavan i kreativan način. Uz to, već imate sve potrebne materijale za ovu aktivnost.
- Ili se možete upustiti u malo izazovniju aktivnost i [**napraviti vlastiti projektor od kartona za mobitel**](/hr/kako-napraviti-projektor-za-mobitel) kako bi mogli gledati video na velikom ekranu, bilo gdje.
