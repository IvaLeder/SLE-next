---
title: "Hanojski toranj: pravila, rješenje i najmanji broj poteza"
translationKey: make-and-solve-tower-of-hanoi
slug: kako-napraviti-rijesiti-hanoi-toranj
lang: hr
subtitle: >-
  Jeste li ikada pokušali rješavati Hanojski toranj? Još od 19. stoljeća ova nam
  mozgalica zagrijava moždane vijuge i pomaže u razvijanju matematičkih vještina
  i algoritamskog načina razmišljanja. Pokazat ćemo vam kako napraviti i
  riješiti Hanoi toranj koji je pogodan za sve uzraste radi lakog prilagođavanja
  težine.
description: >-
  Pravila Hanojskog tornja, rješenje korak po korak, formula 2ⁿ − 1 za najmanji
  broj poteza te upute za izradu vlastite mozgalice.
date: '2020-06-25'
dateModified: "2026-09-02"
author: Vedran Leder
coverImage: /images/posts/Kako-napraviti-i-riješiti-Hanoi-toranj.jpg
heroAlt: "Hanojski toranj"
categories:
  - Matematika
tags:
  - activity
...
<Callout type="tip" title="🎮 Zaigrajte dok čitate">Niže u članku naći ćete digitalni Hanojski toranj koji možete odmah probati. Želite cijelu stranicu? Otvorite [alat Hanojski toranj](/hr/alati/hanojski-toranj).</Callout>

## Pravila Hanojskog tornja u 30 sekundi

Cilj je premjestiti cijeli toranj sa štapa **A** na štap **C**, dok štap **B** služi kao privremeno mjesto:

1. Pomičite samo **jedan disk odjednom**.
2. Pomičite samo **gornji disk** s hrpe.
3. Nikada ne stavljajte **veći disk na manji**.

Počnite s tri diska u digitalnoj mozgalici niže ili [odmah prijeđite na potpuno rješenje u sedam poteza](#rješenje-hanojskog-tornja-s-3-diska).
...
Drugo i najpopularnije ime je **Hanoi toranj** ili **Hanojski toranj** koje je nastalo po legendi o hramu koji se nalazi u glavnom gradu Vijetnama, Hanoi-u.
...
<Figure src="/images/posts/Hanoi-Toranj-Brahma-Toranj-ili-Lukasov-toranj.jpg" alt="Hanoi Toranj (Brahma Toranj ili Lukasov toranj">
...
**Isprobajte odmah ovdje!** Počnite s 3 diska pa povećavajte:
...
<Figure src="/images/posts/Potrebni-materijali-za-napraviti-Hanoi-Toranj.jpg" alt="Potrebni materijali za napraviti Hanoi Toranj">
  Za kućni Hanoi toranj dovoljni su karton, škare i nešto za štapiće.
</Figure>
...
<Figure src="/images/posts/Primjer-Hanoi-tornja-s-3-diska.jpg" alt="Primjer Hanoi tornja s 3 diska">
  Toranj s tri diska savršena je veličina za učenje algoritma rješavanja.
</Figure>
...
## Rješenje Hanojskog tornja s 3 diska

Najmanji disk nazovite **1**, srednji **2**, a najveći **3**. Ako su sva tri na štapu A, ovih sedam dozvoljenih poteza složit će cijeli toranj na štapu C:
...
To je najmanji mogući broj jer je **2³ − 1 = 7**. Isprobajte slijed u mozgalici iznad, zatim otvorite [alat Hanojski toranj preko cijele stranice](/hr/alati/hanojski-toranj) i pokušajte ga ponoviti bez gledanja.

## Obrazac za rješavanje Hanojskog tornja

Nakon nekoliko pokušaja primijetit ćete obrazac koji pretvara nagađanje u pouzdan postupak:

**Svaki drugi potez pripada najmanjem disku.** Pomaknite najmanji disk, napravite jedini drugi dozvoljeni potez, ponovno pomaknite najmanji i nastavite izmjenjivati ta dva koraka.

**Najmanji disk stalno se kreće u istom smjeru:**

- Kod **neparnog broja diskova** (3, 5, 7) kreće se A → C → B → A i tako dalje.
- Kod **parnog broja diskova** (4, 6) kreće se A → B → C → A i tako dalje.

Između njegovih poteza uvijek postoji samo jedan dozvoljeni potez koji ne uključuje najmanji disk. Slijedite li taj obrazac, dobit ćete rješenje s najmanjim brojem poteza:

| Diskovi | Najmanje poteza |
|---:|---:|
| 3 | 7 |
| 4 | 15 |
| 5 | 31 |
...
Ako izgubite redoslijed, nemojte počinjati ispočetka. Pogledajte gdje je najmanji disk, prisjetite se u kojem se smjeru kretao i nastavite obrazac.
...
- [Kako učiti razlomke pomoću Lego kocaka](/hr/kako-nauciti-razlomke-na-lak-nacin) i saznajte kako razlomci mogu biti zanimljivi.
- [7 zabavnih aktivnosti za učenje slova i brojeva](/hr/aktivnost-ucenja-slova-kod-predskolaca) - još jedan način zabavnog učenja brojeva i slova.
- [Zabavne aktivnosti s nizovima](/hr/zabavne-aktivnosti-s-nizovima) - vježbajte logičko razmišljanje uz jednostavnu aktivnost s nizovima koja je pogodna za najmlađu dob.
- [Kako napraviti kotač za šifriranje](/hr/kako-napraviti-kotac-za-sifriranje) - napravite autentičan kotač za šifriranje i učite o kriptografiji, nizovima i algoritmima.
- [Učenje programiranja uz Scratch](/hr/ucenje-programiranja-scratch) - učite programirati uz najbolji programski jezik za početnike i naučite sve o varijablama, petljama i funkcijama.
