...
lang: hr
subtitle: >-
  Govor. Najnapredniji oblik komunikacije. Ne možemo dočekati kada će naši
  mališani konačno početi koristiti riječi nakon, često frustrirajućih, pokušaja
  neverbalnog sporazumijevanja. Postoji mnogo toga što mi roditelji možemo
  učiniti kako bismo poticali razvoj govora i govorne vještine od najranije
  dobi. Idemo istražiti što činiti kako bismo osigurali uvjete za optimalni
  razvoj govora kod djece različite dobi.
description: >-
  Saznajte kako poticati govorni razvoj i učenje riječi kod djece od najranije
  dobi. Naučite najbolje metode i što treba, a što ne raditi.
date: '2020-09-11'
dateModified: "2026-07-15"
author: Vedran Leder
coverImage: /images/posts/Kako-poticati-razvoj-govora-kod-djece-Pocetna-slika-1.jpg
heroAlt: "Papirnata ilustracija triju govornih oblačića punih srca, povezanih zlatnom niti - poticanje razvoja govora kod djece"
categories:
  - Psihologija
tags:
  - child-development
...
<Figure src="/images/posts/Govorni-miljokazi-za-bebe-i-djecu-razlicite-dobi.jpg" alt="Infografika govornih miljokaza po dobi, od prvog osmijeha do punih rečenica u petoj godini">
...
| **Dob od 18 mjeseci**       | Dijete koristi oko 10-20 riječi. Počinje komunicirati riječima kada nešto želi, poput “daj” ili “još”. Neka djeca počinju spajati dvije riječi, poput “pas tamo” ili “daj pit” - to tipično stiže bilo kada između 18. i 24. mjeseca. Prepoznaje dijelove tijela kada ih imenujemo.        |
| **Dob od 2 godine**         | Rječnik se proširuje i dijete zna više od 50 riječi. Sada se očekuju kombinacije od dvije riječi, a neka djeca već prelaze na rečenice od 3 riječi, s pravilnim redoslijedom riječi. Imenuje dijelove tijela, slike u slikovnicama i počinje koristiti množinu pri komunikaciji.                |
...
| **Dob od 3 godine**         | Vokabular je oko 1000 riječi i dijete zna kako se preziva. Može ispričati priču, zna nekoliko uspavanki i zna pjevati pjesmice.                                                                                                     |
...
<Callout type="info" title="Kada se javiti stručnjaku">
Svako dijete ima svoj tempo, no dobro je znati kad se ipak dobro konzultirati sa stručnjakom: nema brbljanja do otprilike 12. mjeseca, nema prvih riječi do 16.-18. mjeseca, nema kombinacija od dvije riječi do 24. mjeseca, govor koji ni vi ne razumijete s 3 godine ili gubitak jezičnih i socijalnih vještina u bilo kojoj dobi. Ako primijetite bilo što od navedenog, obratite se izravno pedijatru ili logopedu. Ranija procjena nikad ne šteti, a čekanje može koštati dragocjeno vrijeme za ranu intervenciju.
</Callout>
...
<Figure src="/images/posts/Razvoj-govora-majka-i-sin-citaju-knjigu.jpg" alt="Papirnata ilustracija majke i djeteta koji zajedno čitaju slikovnicu, rano zajedničko čitanje potiče razvoj govora">
  Knjige djeluju od prvog dana: dovoljno je listati stranice i pričati o slikama.
</Figure>
...
<Figure src="/images/posts/Nudenje-izbora-kao-metoda-usvajanja-govora.jpg" alt="Papirnata ilustracija roditeljske ruke koja nudi jabuku i bananu s upitnikom između njih - jednostavni izbori za širenje djetetova vokabulara">
  Nuđenje dvije opcije zadovoljava potrebu za kontrolom i širi vokabular.
</Figure>
...
Mnoga istraživanja su pokazala kako provođenje vremena pred ekranom može **negativno utjecati na djecu**, između ostalog **i na razvoj govora**. Za dvogodišnje dijete, ograničite boravak pred ekranom na **maksimalno 30 minuta dnevno**. Umjesto ekrana, zabavite se slušanjem audio priča i zajedničkim čitanjem. **Najvažniji faktor** koji utječe na brzinu govornog razvoja je **interakcija licem u lice** s roditeljima i skrbnicima.

<Figure src="/images/posts/Izbjegavajte-vrijeme-pred-ekranom.jpg" alt="Papirnata ilustracija tableta sa satom na ekranu i zlatne staze koja vodi do knjige i kockice - manje ekrana, više prave igre i razgovora">
  Vrijeme pred ekranom dobro je ograničiti, posebno u ranoj dobi.
</Figure>
...
<Figure src="/images/posts/Kategorizacija-za-ucenje-jezika.jpg" alt="Papirnata ilustracija dviju košara, jedne s voćem i jedne sa životinjama, povezanih zlatnim nitima - grupiranje u kategorije za širenje vokabulara">
  Grupiranje riječi u kategorije olakšava kasnije dosjećanje.
</Figure>
...
Odrasli se obožavaju služiti metodom testiranja. No neprestano ispitivanje djeteta “Što je ono?”, “Tko je ovo?” može biti vrlo stresno i živcirati ih. To može dovesti i do neželjenih ponašanja ([tantrumi](/hr/izazovi-roditeljstva-temper-tantrum)). Ako znate da dijete već zna neke riječi, izbjegavajte ga ponovno ispitivati. Do ponavljanja će doći spontano prije ili poslije, ne brinite.

<Figure src="/images/posts/Izbjegavajte-testiranje-onoga-sto-dijete-vec-zna.jpg" alt="Papirnata ilustracija cvijeta čije se latice svijaju uz zlatno srce pod hrpom upitnika - stalno ispitivanje preopterećuje umjesto da pomaže">
...
<Callout type="info" title="Što kažu službene smjernice?">
Američka pedijatrijska akademija preporučuje bez ekrana prije 18. mjeseca (videopozivi s obitelji su iznimka), a za dob od 2 do 5 godina najviše sat vremena kvalitetnog sadržaja dnevno, i to gledanog zajedno s vama. Naš je pristup nešto stroži - shvatite to kao našu preferenciju, a ne recept.
</Callout>
...
<Figure src="/images/posts/Djecak-i-mama-se-igraju-s-kockama.jpg" alt="Papirnata ilustracija djeteta koje gradi s kockama, dok tata promatra, pomoć nudimo tek kad je dijete samo zatraži">
...
Grupno okruženje je zlato za razvoj govora. Naracija rutina, proširivanje dječjih iskaza ("Lopta!" - "Da, velika crvena lopta!") i prave izmjene u komunikaciji kroz pjesmice i igre u krugu čine čuda. Obratite pažnju na tiho dijete koje komunicira samo gestama i podijelite zapažanja s roditeljima rano i s puno takta - odgojitelji su često prvi koji primijete kašnjenje.
...
- [**Kognitivni razvoj vašeg djeteta**](/hr/sto-ocekivati-od-vaseg-djeteta) \- saznajte koje kognitivne miljokaze djeca prolaze u kojoj dobi dok odrastaju.
- [**Aktivnosti za poticanje senzomotoričkog razvoja**](/hr/aktivnosti-za-poticanje-senzomotorickog-razvoja) \- zanimljive aktivnosti i ideje za poticanje senzomotoričkih vještina.
- [**Kako poboljšati radno pamćenje vašeg djeteta**](/hr/kako-poboljsati-radno-pamcenje-vaseg-djeteta) \- Ideje, savjeti i aktivnosti za poboljšanje kratkoročnog (radnog) pamćenja.
- [**7 zabavnih aktivnosti za učenje abecede i brojeva**](/hr/aktivnost-ucenja-slova-kod-predskolaca) - ako ste u procesu učenja slova i brojeva, pogledajte ovih 7 aktivnosti koje će vam pomoći da učite i usput se dobro zabavljate.
