...
<ActivityInfo age="7+" time="30 min" difficulty="Lako" mess="Malen" supervision="no" />
...
Računalna arhitektura favorizira pohranu u setove od  **8 bitova**. Skupina od 8 bitova ima poseban naziv koji ste možda već čuli - **bajt** (engl. _byte_)!
...
<Prediction question="Vaš red! Koje se slovo krije u binarnom kodu 01000010?">
<PredictionOption>A</PredictionOption>
<PredictionOption correct="true">B</PredictionOption>
<PredictionOption>C</PredictionOption>
<PredictionResult>
Uključene su samo žarulje **64** i **2**, pa je 64 + 2 = **66**. Znamo da je **A broj 65**, pa sljedeći broj, 66, mora biti **B**. Upravo ste ručno dešifrirali binarni kod!
</PredictionResult>
</Prediction>
...
Zato moderna računala koriste noviji sustav koji se zove **Unicode** (zapisan kao **UTF-8**) i koji ima mjesta za slova svih jezika svijeta. Cijena toga je da naša posebna slova trebaju **16 bitova (2 bajta)** umjesto 8. Znači da će **ime s Č, Ć, Đ, Š ili Ž biti dulje** jer za ta slova treba 16 perli umjesto 8!

| Slovo | Binarni kod (16 bitova) |
|:---:|:---:|
| Č | 11000100 10001100 |
| Ć | 11000100 10000110 |
| Đ | 11000100 10010000 |
...
<KeyTakeaways>
- Računala razumiju samo **dva stanja - uključeno (1) i isključeno (0)** - jer se ta stanja lako i pouzdano razlikuju pomoću struje.
- Svaka 0 ili 1 je **bit**; skupina od **8 bitova je bajt**, dovoljno za pohranu bilo kojeg slova, broja ili simbola.
- Slova se pohranjuju pomoću tablice **ASCII**: **A je 65, B je 66** i tako dalje, a zatim se broj zapiše binarno (A = `01000001`).
- Binarni kod je **baza 2**: čitajući zdesna nalijevo, svako mjesto se udvostručuje (1, 2, 4, 8, 16, 32, 64, 128); zbrojite uključene žarulje da dobijete broj.
- Naša slova s kvačicama (Č, Ć, Đ, Š, Ž) trebaju **16 bitova (Unicode/UTF-8)**, a LJ, NJ i DŽ pohranjuju se kao **dva slova** - pa neka imena budu dulja.
</KeyTakeaways>

## Često postavljena pitanja

<FAQ>
<Question question="Kako napisati svoje ime binarnim kodom?">
Napišite ime velikim slovima, zatim za svako slovo potražite njegov 8-bitni kod u tablici binarnog pisma (na primjer A = 01000001). Spojite kodove, slovo po slovo, i dobili ste svoje ime u binarnom kodu - spremno za izradu narukvice od perli.
</Question>
<Question question="Što je binarni kod?">
Binarni kod je brojevni sustav koji koristi samo dvije znamenke, 0 i 1. Računala ga koriste jer njihovi sićušni prekidači (tranzistori) mogu biti samo isključeni (0) ili uključeni (1). Kombiniranjem mnogo nula i jedinica računalo može prikazati bilo koji broj, slovo, sliku ili zvuk.
</Question>
<Question question="Što je bit, a što bajt?">
Bit je jedna 0 ili 1 - riječ dolazi od engleskog "binary digit" (binarna znamenka). Bajt je skupina od 8 bitova, standardna jedinica pohrane. Jedan bajt može sadržavati bilo koju vrijednost od 0 do 255, dovoljno za svako svakodnevno slovo, broj i simbol.
</Question>
<Question question="Što je ASCII?">
ASCII (izgovara se "ASKI") je dogovorena tablica koja svakom slovu i simbolu dodjeljuje broj - veliko A je 65, B je 66 i tako dalje. Računalo taj broj zatim pohrani u binarnom kodu, i tako slova završe kao nizovi nula i jedinica.
</Question>
<Question question="Zašto računala koriste samo nule i jedinice?">
Sve se svodi na struju. Pouzdano razlikovati deset različitih jačina struje bilo bi teško, ali razlikovati samo dva stanja - ima napona (1) ili nema (0) - lako je i bez pogreške, baš kao prekidač za svjetlo. Ta pouzdanost razlog je zašto sva digitalna tehnologija počiva na binarnom kodu.
</Question>
<Question question="Kako se naša slova s kvačicama (Č, Ć, Š, Ž, Đ) zapisuju binarno?">
ASCII je smišljen 1960-ih samo za englesku abecedu pa u njemu nema mjesta za Č, Ć, Đ, Š i Ž. Zato računala koriste noviji sustav Unicode (UTF-8) u kojem naša posebna slova trebaju 16 bitova (2 bajta) umjesto 8 - pa je za njih potrebno 16 perli.
</Question>
</FAQ>

Ako ste uživali u ovoj aktivnosti, evo još neke koje biste mogli isprobati:

- Otkrijte kako su ljudi slali kodirane poruke prije računala u [**povijesti komunikacije za djecu**](/hr/povijest-komunikacije-za-djecu), od dimnih signala i Morseove abecede do današnjeg interneta.
