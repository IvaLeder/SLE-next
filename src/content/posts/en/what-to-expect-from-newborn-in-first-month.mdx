...
- **Rolling the baby in the blanket - swaddling** - another method that showed great results in many babies. It also simulates cramped space of mothers womb by restricting the movement of the baby. It makes it feel secure and calms it down. Two safety notes: stop swaddling at the very first signs of rolling, and keep the wrap loose around the hips so the little legs can bend freely.
