...
And if you are interested in more similar STEM activities, check out a simple but great [orange density experiment](/en/orange-density-experiment/). Also, be sure to check how to [demonstrate osmosis with gummy bears](/en/gummy-bears-osmosis-experiment/) and [learn about pressure with can crush experiment](/en/can-crush-experiment/).
