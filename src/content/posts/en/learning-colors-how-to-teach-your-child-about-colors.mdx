...
<Callout type="tip" title="🎨 Try it as you read">This guide has a color mixing lab built in  - scroll down to mix paints and light on screen and test yourself in the quiz. Prefer a full page? Open the [color mixing lab](/en/tools/color-mixer).</Callout>
...
Before (or after) the real experiment, try mixing on screen. Tap two paint pots to see which color appears, make it lighter or darker, switch to mixing light, then test yourself in the quiz. The tool also lives on [its own page](/en/tools/color-mixer).
