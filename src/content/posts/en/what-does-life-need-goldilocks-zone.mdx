...
Earth may be home to as many as a trillion **microbial species**, plus every plant and animal from a daisy to a blue whale. They live in deserts, in ice, in caves and on your skin. At first glance, many look nothing like each other.

And yet all known life shares a few basic needs. Those needs are among the best clues we have when we search for life somewhere else, because we cannot inspect a whole galaxy at random. The **Goldilocks zone** is one useful shortcut — but, as we will see, it is only the beginning of the search.
...
These are search clues, not a magic recipe. Water, energy and chemical building blocks are the essentials; workable surroundings and time give life a chance to begin and continue.
</Figure>
...
All life we know uses liquid water. Living things are very complicated chemistry sets, and their ingredients need somewhere to move, meet and react. In solid ice, that movement becomes extremely slow. In a gas, the molecules spread far apart. Liquid water provides a busy in-between space where chemistry can happen.
...
Most life on Earth's surface ultimately runs on **sunlight**. Plants catch it, animals eat the plants, and so on up the chain. But sunlight is not the only option, and that matters enormously. At the bottom of the ocean, kilometres below the last scrap of daylight, crowded communities live around **hydrothermal vents**: cracks where hot, chemical-rich water pours out of the seafloor. The microbes at the base of that food web run on chemistry instead of light.
...
On Earth's surface, our **atmosphere** absorbs much of the harmful radiation that arrives from space, while our **magnetic field** deflects many charged particles. But protection does not have to mean air. Water, a few metres of rock or a thick layer of ice can also provide shelter. That loophole will matter later.

### 5. Enough time

Time is not something an organism eats or drinks. It matters to a **world**: even a promising place needs enough stable time for complex chemistry to get started and for life to change and diversify.
...
Here is the shortcut astronomers use. The fussy clue is **liquid water**, because it stays liquid only across a limited range of temperatures and pressures. For any particular star, distance helps determine a planet's temperature — but the star's brightness and the planet's atmosphere, clouds and reflectivity matter too.

Too close and surface oceans are likely to evaporate. Too far and they are likely to freeze. Between those extremes is a band of useful distances with a name every child recognises instantly.
...
Extremophiles do not break the basic needs of life. Instead, they show that the range of **workable surroundings** is far wider than human comfort suggests. Biologists kept looking in places where nobody expected life and kept finding it anyway. We call these organisms **extremophiles**, meaning "lovers of extremes".
...
Take a small clump of moss from your own garden or another place where collecting is allowed. Soak it in a saucer of water overnight, squeeze the water out and inspect a drop under a microscope at about 40 to 100 times magnification. Tardigrades are common and surprisingly charming to watch trundling about. You will be looking at the same kind of animal whose relatives survived exposure to space. Wash your hands when you finish.
</Callout>

## The shortcut's loophole: oceans in the dark

Put the extremophiles together with hydrothermal vents and you get an idea that has redirected an entire field.
...
**Enceladus**, a small moon of Saturn, fires jets of water and ice through cracks near its south pole. The Cassini spacecraft flew through those plumes and sampled salt, silica, phosphorus and organic molecules — exactly the sort of mixture expected when warm water meets rock.
...
Neither moon is proof of anything living. But together they show why the honest answer to "where should we look?" is much larger than a neat green ring.

## Are we alone?

Nobody knows. That answer is worth giving a child plainly rather than dressing it up.
...
Within a single lifetime, we have gone from not knowing whether planets around other stars existed to arguing about which ones to point our best telescopes at first. That is a remarkable place to have arrived, and your explorer gets to find out what happens next.
...
The five search clues work from about **age 5** if you keep them to water, energy, building materials, a safe place and time. The Goldilocks zone lands well at **7 and up**, especially with a drawing of the three zones. Extremophiles and hidden oceans suit **9 and up**, and tend to be the part that sticks.
</Question>
</FAQ>
