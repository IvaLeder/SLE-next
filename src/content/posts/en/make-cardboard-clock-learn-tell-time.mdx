...
Start with the two hands: the short one points to the hour, the long one to the minutes. Teach the "landmark" times first — o'clock, half past, quarter past, and quarter to — then practice counting the minutes in fives. A hands-on clock your child can turn themselves, like the cardboard one in this article, makes it much easier.
</Question>
