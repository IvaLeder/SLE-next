...
The rainbow is a **phenomenon** that appears in the sky when the right conditions are met - when there is sun and the rain at the same time. It is a **multi-colored**, **arc-shaped** phenomenon that is created by **reflection**, [**refraction**](/en/how-to-demonstrate-refraction/), and **dispersion** of light while it passes through the water droplets in the air. The light from the sun bounces off the raindrops and splits into rainbow stripes.
...
- **Food colors**. You can try and experiment with different colors, not just food colors. But if your toddler is prone to putting things in mouth, we recommend sticking to the food colors. Red, Yellow and Blue color is enough since we can [mix all other colors](/en/learning-colors-how-to-teach-your-child-about-colors/) using those three.
...
- Repeat the process for each color you want to add on the rice. Remember that [you can mix colors](/en/learning-colors-how-to-teach-your-child-about-colors/) so you are not limited to only those you have. For example, **red + yellow will give orange**. **Blue + red will give purple**. You can experiment here and see what kind of colors you can get!
...
We hope you will enjoy making the colored rice and playing with it as much as we did. And if you’re searching for more interesting kitchen activities with colors to boost your STEM skills, check out [how to make sensory play colors](/en/make-sensory-play-colors/). If you want to dig even deeper into chemistry processes, check out the [milk polarity experiment](/en/make-colorful-milk-polarity-experiment/) and [how to make a lava lamp](/en/make-lava-lamp/). And finally, we recommend trying the [dancing grain experiment](/en/dancing-grain-experiment/) for some fun visual activity.
