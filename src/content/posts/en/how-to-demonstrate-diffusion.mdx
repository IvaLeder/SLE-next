---
title: "Diffusion Experiment: Hot vs. Cold Water with Food Coloring"
translationKey: how-to-demonstrate-diffusion
slug: how-to-demonstrate-diffusion
lang: en
subtitle: >-
  Does food coloring spread faster in hot or cold water? Compare both glasses
  side by side, then discover how temperature changes particle motion and
  diffusion.
description: >-
  Add food coloring to hot and cold water and watch diffusion happen. This
  simple experiment shows how temperature changes the speed of moving particles.
date: '2020-05-13'
...
Let’s get some complex-sounding terminology out of the way. When talking about diffusion, we often hear something about the concentration gradient (or electrical gradient if looking at electrons). **Gradient** just means a change in the quantity of something over some distance. In the case of concentration gradient, a "something" that changes is the concentration of a substance. So we can define the **concentration gradient** as the space over which the concentration of our substance changes.
...
<Callout type="science" title="Honest science: it isn't pure diffusion">
Freshly poured hot water is still churning inside from the heating, and those slow currents, called **convection**, carry the colour around much faster than diffusion alone ever could. So the fast swirl you see in the hot glass is partly diffusion and partly convection working together.

Want to see closer to pure diffusion? **Let both glasses stand for a few minutes first** so the water goes completely still, then add the colour as gently as you can and watch without bumping the table. The spreading is slower and calmer, but it is much more truly diffusion. The hot water will still win the race, but the difference is less dramatic.
</Callout>
...
You are already comparing two temperatures: now make it a proper measurement. Set up three or more glasses across a range of temperatures (fridge-cold, room temperature, warm, and near-boiling with an adult), add one drop of colour to each at the same moment, and time how long each takes to colour evenly. Plot temperature against time and you have a real data set showing exactly how heat speeds diffusion up.
</Callout>
