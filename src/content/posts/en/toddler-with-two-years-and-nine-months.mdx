...
lang: en
subtitle: >-
  And we are in the second half of the third year. Admittedly, it was a less
  emotionally turbulent quarter compared to the first half of the year. But that
  doesn’t make it less dynamic! From removing daily naps to longer self-play and
  boosting immunity (read: putting everything in mouth again), it was another
  interesting period. So let’s dive in and explore the third quarter of the
  third year.
description: >-
  Find out what to expect from a Toddler with Two Years and Nine Months. Big
  changes in Sleeping Routine, Play, Planning, and much more.
date: '2021-01-02'
dateModified: '2026-07-15'
author: Iva Leder
coverImage: >-
  /images/posts/What-to-expect-from-Toddler-with-Two-years-and-Nine-Months-Cover-Image.jpg
heroAlt: "Papercut illustration of a toddler stacking a tall tower of paper blocks while a sheepdog sleeps behind her - what to expect from a toddler at two years and nine months"
categories:
  - Psychology
tags:
  - child-development
...
Here we will be talking about the changes and development milestones we noticed in a child from two and a half years old to 2 years and nine months of age. If you would rather know more about the first year of a baby’s life, be sure to check [**the first year of a child’s life**](/en/category/psychology) section. And if you are interested in the child from 1 year old to 2 years old, you can check all about it in [**the second year of the child life category**](/en/category/psychology).
...
<Figure src="/images/posts/Problems-Getting-to-sleep-over-Night-close-to-3-years.jpg" alt="Papercut illustration of an empty child's bed under a crescent moon and stars - sleep troubles are common as the third birthday approaches">
  You can expect issues with sleeping as you get closer to the 3rd year.
</Figure>
...
After some research, we decided to try dropping the nap and to have an earlier bedtime. It worked! She is sleeping 12 hours over the night and (for now) we didn’t notice any indication she is missing the nap. It’s quite early to drop the nap though, so we will keep observing.

How much sleep do preschoolers really need? A shockingly large amount. **Toddlers** (1-2 years) **need from 11 to 14h of sleep per day**, naps included! For older toddlers, there is usually a 1-3h nap and the rest is the night sleep. For children in the 3-5 years category, there is just a slight drop, 10-13h.
...
But that also has a bad side, sanitation is removing all microorganisms, even those which are helpful to us. Humans live in a sort of symbiosis with a huge number of different bacteria, and only now we are starting to understand how important they are, especially for our gut health.

Early exposure to everyday microbes may be **important for developing a healthy, not overly reactive immune system**. This is the “hygiene hypothesis” - one proposed (and still debated) explanation for the rise in autoimmune diseases and allergies in modern societies.

Seems **a bit like a catch-22**, right? How much is enough, how much is too much? Well, you don’t have to worry, since our children know what to do. They will get those microorganisms in themselves in any way they can. Mouthing is simply how babies and toddlers explore, and ordinary outdoor mess is not the enemy. So, let them walk barefoot over grass and dirt, let them roll in the mud, and pretend you don’t see them licking that sand ice cream.

<Figure src="/images/posts/Child-immunity-system-improves.jpg" alt="Papercut illustration of a shield with a star, a leaf and two friendly microbes - everyday germs help train a child's strengthening immune system">
  A little dirt goes a long way: everyday microbes help train the immune system.
</Figure>

Hey, that doesn’t mean I won’t clean my child’s hands (probably too many times) or that I will encourage her to sample the mud cake. But I won’t freak out when she finds those opportunities herself. And I know she definitely will. (Common sense still applies: steer clear of spots animals use as a toilet and of soil right next to busy roads, and wash hands before eating.)

*A little time capsule: the next few paragraphs were written in early 2021, in the middle of the pandemic.*
...
<Figure src="/images/posts/Toddler-playing-by-itself-in-third-year.jpg" alt="Papercut illustration of a toddler kneeling and arranging paper shapes in a row - longer, more focused independent play in the third year">
...
She also showed a **big interest in puzzles**. First, she started with 6 piece puzzles. And she was struggling with them for a couple of days, asked for help, improved, and mastered the images. But she used them so much that the cardboard puzzles wore out. So we bought 12 piece puzzles that she still struggles with. It can be frustrating for her, but as every child, she doesn’t surrender that easily. She may take a pause but every now and then she goes back to them and each time there is an improvement.
...
By doing everything for our little ones, we are just showing them that we think they are unable to do things by themselves and that there is no point in trying. And that is not what we want. We need to **encourage them** but also **support them**. Not an easy balancing act, right?
...
But in the last couple of months, things changed. Sometimes, after work, I just want to relax for 30 minutes by sitting and watching [Daniel Tiger](https://en.wikipedia.org/wiki/Daniel_Tiger%27s_Neighborhood). But no! Her favorite cartoon is not that fun anymore. Why watch screens when we can build a farm for animals, cook lunch for animals, treat animals… Yes, she really likes her animals.
