...
subtitle: >-
  STEM – seems that’s everyone’s favorite buzzword lately and for a good reason.
  But what does it mean? STEM is an acronym for **Science**, **Technology**,
  **Engineering** and **Math** and it’s becoming an increasingly important topic
  in Early Education.
description: >-
  STEM jobs are growing three times faster than the rest of the economy. Learn
  what STEM is and why early STEM education matters.
date: '2018-06-16'
dateModified: '2026-07-15'
author: Iva Leder
coverImage: /images/posts/What-is-STEM-1.jpg
heroAlt: "Word STEM written inside an engineering wrench with question marks around it"
categories:
  - Science
tags:
  - stem
...
A simple project can cover all four fields at once. A [paper windmill](/en/how-to-make-paper-windmill), for example, combines the science of moving air, the engineering of blade shape, the technology of wind turbines and the geometry of folding.
...
The numbers back this up. The US Bureau of Labor Statistics [projects that STEM occupations will grow by 8.1% between 2024 and 2034](https://www.bls.gov/emp/tables/stem-employment.htm), against just 2.7% for everything else - roughly three times faster than the rest of the economy. Computer and mathematical jobs are growing fastest of all, at 10.1%, driven by artificial intelligence and the sheer amount of data now waiting to be made sense of. Technology is making various jobs obsolete and that will only continue. But how do we create that technology? You need **Math** to do **Science**. And **Science** to create **Technology**. And that technology is only good if you can **Engineer** a working product that will do what we want it to do. And in all that, there is an important place for design thinking and making products not only usable but a joy to use.

Do you see now why is so important to involve kids in STEM education as soon as possible?

If you want to dig deeper into STEM, check out [Exploring STEM Fields](/en/exploring-stem-fields) where we talk about individual fields in more detail.
...
One part of the STEM story deserves its own article: girls are still badly under-represented in these fields, and a lot of that is decided long before anyone picks a career. We wrote about why that happens and what helps in [women in STEM and encouraging girls towards STEM careers](/en/women-in-stem-encouraging-girls-for-stem-careers).
