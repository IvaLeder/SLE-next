...
lang: en
subtitle: >-
  Programming is one of the most popular and useful skills these days. But let’s
  say it’s not one of the easiest skills to master. But learning to program
  doesn’t have to be tedious and it can be really fun! Meet the Scratch -
  programming language that children and beginners will love. Scratch will help
  you learn to program and create awesome things really fast.
description: >-
  Scratch is one of the best programming languages for Kids and Beginners. Learn
  the programming logic that will help you improve coding skills
date: '2020-03-18'
dateModified: "2026-07-19"
author: Iva Leder
coverImage: /images/posts/Learn-to-Program-with-Scratch-Cover-Image.jpg
heroAlt: "Learning to program with Scratch"
categories:
  - Technology
tags:
  - activity
...
<ActivityInfo age="8-16" time="45 min per part" difficulty="Beginner" mess="None" supervision="no" />
...
<Callout type="tip" title="Learn by remixing">
...
<Callout type="info" title="A note about the screenshots">
...
<Figure src="/images/posts/Learn-to-Program-with-Scratch-The-parts-of-the-screen.jpg" alt="The Scratch editor with the stage, blocks palette, and scripts area labeled">
...
<Figure src="/images/posts/A-simple-Loop-made-in-Scratch.jpg" alt="A simple repeat loop built from colorful Scratch blocks">
...
<Prediction question="What happens if a loop never updates its variable toward the stopping condition?">
<PredictionOption>It runs exactly once and stops</PredictionOption>
<PredictionOption>It refuses to start</PredictionOption>
<PredictionOption correct="true">It runs forever - an infinite loop</PredictionOption>
<PredictionResult>
Without the **update** step, the condition never becomes false, so the loop repeats endlessly - the dreaded **infinite loop**. In our apple-seller story, if the apple count never dropped by 1, he could never sell out and never go home. Always make sure something inside the loop moves it closer to stopping.
</PredictionResult>
</Prediction>
...
<Figure src="/images/posts/Learn-to-Program-with-Scratch-Defining-a-Function.jpg" alt="Defining a custom block, or function, in the Scratch editor">
...
<FAQ>
<Question question="What age is Scratch for?">
...
<Question question="Is Scratch free?">
...
<Question question="Do you need to know how to code to teach Scratch?">
...
<Question question="What is the difference between Scratch and ScratchJr?">
...
<Question question="Do children type code in Scratch?">
...
<Question question="What can you make with Scratch?">
...
<Question question="Is Scratch good for learning real programming?">
...
If you are interested in more technology field STEM ideas, but maybe without the code and screen, we have some recommendations for you. Check out [how to make a cipher wheel](/en/how-to-make-cipher-wheel) and learn about cryptography, then follow those codes from Morse to binary in the [history of communication for kids](/en/history-of-communication-for-kids). And what about learning algorithms while [building a Hanoi Tower](/en/make-and-solve-tower-of-hanoi)? For both of those activities, you need only some cardboard, pencil and scissors and enjoy improving technology skills. And if you have a smartphone and are in need of a projector, check how to [make your own cardboard projector](/en/how-to-make-projector-using-smartphone).
