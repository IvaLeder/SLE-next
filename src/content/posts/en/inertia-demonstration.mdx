---
title: "Inertia and Newton's Laws: The Chain Fountain Experiment"
...
subtitle: >-
  ...
  universe? Resistance to change even has a name - inertia. Let’s explore it,
  meet all three of Newton’s laws of motion, and watch them team up in a
  mesmerising experiment: the chain that leaps out of its own cup.
description: >-
  What is inertia? Newton's laws of motion explained for kids, plus the amazing
  chain fountain experiment and the science of why the beads leap upward.
date: '2020-03-16'
...
A chain of beads poured from a cup leaps up into an arch before it falls, because moving beads keep moving and pull the rest up after them.
</Callout>

## What is inertia? Newton's first law in simple terms
...
### Why does the chain leap upwards? Newton's laws, together

What is this sorcery? How are beads defying gravity?

This is where our three laws stop being a list to memorise and start working as a team. The phenomenon of the “**chain fountain**” caught the public's attention when it was showcased in a YouTube video by Steve Mould in 2013, and it sent physicists scrambling to explain it.

Start with **inertia** (the first law). Once the beads at the falling end are moving, they *keep* moving - that speeding stream of beads doesn't want to stop or change direction. It just pours downward, dragging the rest of the chain along behind it.

Now the clever part, and it is pure **third law** (action and reaction). To join the moving stream, each bead has to be yanked up and out of the pile in the cup. As the chain pulls up on a bead, that bead pushes back down on the pile. Add up all those little downward pushes and the pile effectively shoves the chain upward - hard enough to fling it into an arch above the rim before gravity wins and brings it down. Your small pull triggers it, but the upward kick comes from the chain pushing against itself.

<Callout type="science">
Scientists are still refining exactly how big that upward kick is and why. The "the pile pushes back" picture above is the leading explanation (proposed by physicists Biggs and Warner in 2014), but the chain fountain is a genuine, recent piece of physics that researchers are still poking at - a nice reminder that not everything is settled in a textbook.
</Callout>

<Callout type="tip" title="🔬 Make it a real experiment">
Change the drop and watch the arch. Hold the cup at different heights above the floor and see how the height of the leaping arch changes, keeping the same chain each time. A longer drop pulls the chain faster, so the arch should climb higher. If you have chains with different bead sizes, compare those too.
</Callout>
