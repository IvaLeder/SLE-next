...
A few simple balloon tricks reveal big science: gas that blows them up, water that fireproofs them, and spread-out pressure that lets them rest on a bed of pins.
</Callout>
...
One thing to expect in experiment 2: the water balloon **will** burst eventually, once the flame has heated all the water through. That is the experiment finishing, not a mistake - but it means about 200 ml of water landing on a lit candle, so hold it over a tray, a sink, or the garden rather than the kitchen table, and keep faces well back the whole time.
</Callout>
...
<Figure src="/images/posts/Many-Kind-of-Balloons-Today.jpg" alt="A colorful assortment of inflated balloons in different shapes and sizes">
...
For a rigid-container comparison, try the [can crush experiment](/en/can-crush-experiment): instead of stretchy rubber expanding, a thin aluminium can collapses when its inside pressure suddenly drops.

But there is a twist! Balloons possess certain **elasticity** that plays an important role. Now the air inside needs to have a lot more pressure since it must counteract the elastic membrane of the balloon that tries to return in the original state and the air pressure from the inside. That makes the balloon light and with some gases like **helium** even lighter than atmospheric air.
...
<Figure src="/images/posts/How-to-use-Science-to-Blow-Up-a-Balloon.jpg" alt="A balloon inflating on top of a bottle as baking soda and vinegar react">
...
1. Pour 200 ml of vinegar into the empty bottle.
2. Put the balloon on the funnel and pour 2 spoons of baking soda into it. If you put more, the reaction will be stronger but there is danger of liquid shooting out of the bottle
3. Now put the balloon on the bottle, lift it up, so soda drops into the vinegar. After a few seconds the balloon will be blown.
4. Use yarn to tie down the balloon and you are done!
...
<Figure src="/images/posts/Burning-a-Balloon-without-popping-it.jpg" alt="A lit flame held close to a water-filled balloon without it bursting">
...
1. Put the balloon onto the faucet and let it fill with water (around 200 ml). Blow up the balloon and tie it down. You can also first blow up the balloon then put it on the bottle with water and just fill it.
2. Light the candle and bring the balloon over it. The balloon won’t pop! If you try it with an empty balloon it will pop instantly.
...
<Figure src="/images/posts/Pinning-a-Balloon.jpg" alt="A wooden skewer pushed through a balloon without popping it">
...
2. If you try putting it on one pin it will pop. Put many pins on the surface (sharp part up) and then try to put the balloon on top of it. It won’t pop!
...
<Figure src="/images/posts/Balloon-on-the-Stick.jpg" alt="A balloon threaded onto a wooden stick">
...
4. Pierce the balloon on one of the spots we previously identified and push it in. Let it come out on the other spot, on the opposite end. You now have a balloon on the stick!

### The science behind the balloon on the stick experiment

A balloon is made of rubber, and that rubber consists of long chains of **polymers**. Blowing up the balloon stretches these polymer chains, and the rubber is then under **tension**, pulling tight in every direction like a stretched elastic band.

But it is not stretched evenly. The rubber is thickest at the very top and right around the knot, which is why those spots look darker, and thick rubber stretches less. So the tension there is much lower. Everywhere else the rubber is thin and pulled tight, and a hole in tight rubber tears open instantly - that is the pop. At the two low-tension spots, the rubber is relaxed enough to close around the skewer instead of ripping, and the balloon survives.
...
<Figure src="/images/posts/Demonstrating-Centripetal-force.jpg" alt="An object spun around the inside of a clear balloon to demonstrate centripetal force">
...
The important force here is the **centripetal force**. This is a centre-seeking force: it acts on our coin and constantly changes its direction so it keeps going in a circle. Left alone, the coin would fly off in a straight line, so something has to keep pulling it back towards the middle.

So what is doing the pulling here? It is the **balloon wall itself**. The rubber is curved, and as the coin presses outward against it, the wall pushes straight back inward on the coin. That inward push is the centripetal force, and it is the only reason the coin curves around instead of shooting off.

**Friction** has a different job. It is the grip between the coin and the rubber, and it is what makes the coin roll and spin rather than slide about. There is not much of it, which is why the coin keeps going for so long after you stop moving your hand.

The same idea works far beyond balloons, just with a different force doing the pulling. For the Moon going around the Earth, it is **gravity** that plays the centripetal role. For a ball on a string, it is the string.

<Callout type="tip" title="🔬 Make it a real experiment">
Take the fireproof balloon (experiment 2) and turn it into a measured test. Fill three balloons with different amounts of water and, holding each over the flame with an adult, time how long each lasts before it pops. More water should mean more seconds, because there is more of it to soak up the heat. Keep the flame and the distance the same, so the only thing you change is the amount of water.
</Callout>
...
- **Balloon on a stick**: pierce it at the least-stretched spots (top and knot), where the rubber is thickest and under the least tension.
