...
One thing to expect in experiment 2: the water balloon **will** burst eventually, once the flame has heated all the water through. That is the experiment finishing, not a mistake - but it means about 2 dL of water landing on a lit candle, so hold it over a tray, a sink, or the garden rather than the kitchen table, and keep faces well back the whole time.
</Callout>
