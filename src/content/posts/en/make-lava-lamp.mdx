...
Oil floats on water, and fizzing tablets send coloured blobs bubbling up and down like a lava lamp.
</Callout>
...
<Figure src="/images/posts/Polar-and-nonpolar-molecules.jpg" alt="Diagram contrasting polar water molecules with nonpolar oil molecules" width="600" height="428">
...
<Figure src="/images/posts/Materials-needed-to-make-Lava-Lamp.jpg" alt="Lava lamp materials: an empty bottle, water, oil, food coloring, and a fizzing tablet" width="600" height="428">
...
- **Kitchen or cooking oil**. We will need to fill 3 quarters of the bottle with oil. So if we are using a 1-liter bottle, we need 750 ml (about 3 cups) of cooking oil. Any liquid oil will do the trick. We can also use baby oil as an alternative to cooking oil.
...
<Prediction question="You add a few drops of water-based food colouring on top of the oil. Which layer will it colour?">
<PredictionOption>The oil layer</PredictionOption>
<PredictionOption correct="true">It sinks through the oil and colours the water</PredictionOption>
<PredictionOption>Both layers evenly</PredictionOption>
<PredictionResult>
The colouring is **water-based**, so it can't mix with the nonpolar oil - "**like dissolves like**." The drops slide straight through the oil layer and only colour the water at the bottom. That's exactly why the "lava" blobs you see next are coloured: it's the water travelling up and down, never the oil.
</PredictionResult>
</Prediction>
...
Change **one thing** and watch the blobs. Try half a tablet versus a whole one, or a warm bottle versus a cold one, keeping the same oil and water. Count how many blobs rise in thirty seconds, or time how long the bubbling lasts. Warmth and more tablet should both make a livelier lamp.
</Callout>
...
<KeyTakeaways>
- A homemade lava lamp is made from **water, oil, food colouring, and a fizzing (effervescent) tablet** - no heat or electricity needed.
- **Oil and water don't mix** because water is **polar** and oil is **nonpolar**, and "like dissolves like" - so water-based colour stays in the water only.
- **Oil floats** because it is **less dense** than water.
- The fizzing tablet reacts with water to make **carbon dioxide** gas; the light bubbles rise and carry coloured water up, then it sinks back once the gas escapes - that's the "lava."
- Drop in a **new tablet** any time to restart the show, and change one variable (tablet amount, temperature) to turn it into a real experiment.
</KeyTakeaways>
