...
- **Paint**. We will need some watercolors or **acrylic colors** to transform our pinecone into a holiday tree. Since we are making evergreen tree, green colour is mandatory. Other colours are not mandatory since we can decorate our tree with any colors.
...
1.  Prepare **paint** and a **pinecone**. Use green colour to fully color the pinecone. Pinecone has many nooks and crannies so take your time coloring the pinecone. After you are done, leave the pinecone to dry. It can take a couple of hours, depending on how thick of a layer of watercolor you applied.
2.  After the green paint dried, we have our pinecone tree. Now it’s **time to decorate**. You can go full creative here since there is no one right way to decorate your Christmas tree. You can use **different colours** to draw decorations. You can use a **decorative chain** if you have some that are thin. You can use **pom-poms** as little balls. **Glitter** is excellent to make our tree sparkly. As you see, we can add whatever we want here.
