...
Cooking flour, salt, water, and oil together makes soft, squishy dough you can shape and colour.
</Callout>
...
Change one ingredient at a time to see what each does. Make one batch with double the salt, one with no oil, and one exactly by the recipe, keeping everything else the same. Compare how stretchy, crumbly, or sticky each feels. This is how real recipes are perfected: one change, one comparison, at a time.
</Callout>
