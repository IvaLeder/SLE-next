---
title: "Tower of Hanoi Pattern: Rules, Solution & Minimum Moves"
translationKey: make-and-solve-tower-of-hanoi
slug: make-and-solve-tower-of-hanoi
lang: en
subtitle: >-
  Have you ever heard of the Tower of Hanoi? It’s a great mathematical puzzle
  that quickly becomes deviously hard! It was invented in the 19th century and
  since then it’s been used as a way to practice math concepts and algorithmic
  thinking. Today, we will show you how to make your own version of this popular
  puzzle and also how to solve it. Difficulty can be modified by the number of
  pieces, so it’s appropriate for any age.
description: >-
  Tower of Hanoi rules, the algorithm to solve it, the minimum-moves formula
  (2^n − 1: 7 moves for 3 disks, 31 for 5), and how to make your own puzzle.
date: '2020-06-25'
dateModified: "2026-09-02"
author: Iva Leder
coverImage: /images/posts/How-to-make-and-solve-the-Tower-of-Hanoi.jpg
heroAlt: "The Tower of Hanoi puzzle"
categories:
  - Math
tags:
  - activity
...
title="Tower of Hanoi (Lucas Tower): How to Make and Solve It"
/>

<ActivityInfo age="5+" time="30 min" difficulty="Easy" mess="Low" supervision="yes" />

<Callout type="tip" title="🎮 Play as you read">This article has a playable Tower of Hanoi built in - scroll down to try it with 3 to 6 disks. Prefer a full page? Open the [Tower of Hanoi puzzle tool](/en/tools/tower-of-hanoi).</Callout>

## Tower of Hanoi rules in 30 seconds

The goal is to move the complete stack from peg **A** to peg **C**, using peg **B** as temporary storage:

1. Move only **one disk at a time**.
2. Move only the **top disk** of a stack.
3. Never place a **larger disk on a smaller disk**.

Start with three disks in the playable puzzle below, or [jump to the complete seven-move solution](#tower-of-hanoi-solution-for-3-disks).
...
## How the Tower of Hanoi puzzle works
...
<Figure src="/images/posts/Tower-of-Hanoi-Tower-of-Brahma-or-Lucas-Tower.jpg" alt="A Tower of Hanoi puzzle with a stack of graduated disks on three pegs">
...
## Tower of Hanoi minimum-moves formula
...
<Prediction question="Solving the tower with 3 disks takes 7 moves. What's the minimum number of moves for 4 disks?">
<PredictionOption>8</PredictionOption>
<PredictionOption>14</PredictionOption>
<PredictionOption correct="true">15</PredictionOption>
<PredictionResult>
**15 moves.** Each extra disk roughly **doubles** the work: the minimum follows the formula **2ⁿ − 1**, so 4 disks need 2⁴ − 1 = 16 − 1 = 15. To move 4 disks you first move the top 3 out of the way (7 moves), move the biggest disk (1 move), then move the 3 back on top (7 more): 7 + 1 + 7 = 15. That doubling is exactly why 64 disks would take longer than the age of the universe.
</PredictionResult>
</Prediction>

## Materials needed for Hanoi Tower

<Figure src="/images/posts/Materials-Needed-to-make-Tower-of-Hanoi.jpg" alt="Tower of Hanoi materials: cardboard, scissors, and rods for the pegs">
...
<Figure src="/images/posts/Example-of-Hanoi-Tower-with-3-disks.jpg" alt="A three-disk Tower of Hanoi part-way through being solved">
...
### If we have an even number of pieces
...
Call the smallest disk **1**, the middle disk **2** and the largest disk **3**. Starting with all three on peg A, these seven legal moves build the complete tower on peg C:
...
That is the minimum because **2³ − 1 = 7**. Try the sequence in the puzzle above, then open the [full-page Tower of Hanoi tool](/en/tools/tower-of-hanoi) and see whether you can repeat it without looking.
...
<FAQ>
<Question question="What is the minimum number of moves in the Tower of Hanoi?">
...
<Question question="How do you move all the disks to tower 3?">
...
<Question question="What is the pattern for solving the Tower of Hanoi?">
...
<Question question="Why is it called the Tower of Hanoi?">
...
<Question question="Is the Tower of Hanoi good for kids?">
...
- [Learning Fractions with Lego](/en/how-to-learn-fractions-fun-easy-way) - and see how easy and fun fractions can be.
- [7 fun activities with Letters and Numbers](/en/learning-letters-for-preschoolers-activity) - another fun way to learn letters and numbers.
- [Fun activities for matching Patterns](/en/activities-for-matching-patterns) - practice logical skills with this simple pattern matching activity for the earliest ages.
- [How To make Cipher Wheel](/en/how-to-make-cipher-wheel) - make an amazing cipher and learn cryptography, patterns, and algorithms.
- [Programming with Scratch](/en/learn-programming-with-scratch) - learn with the best programming language for beginners and find out all about loops, variables, and functions.
