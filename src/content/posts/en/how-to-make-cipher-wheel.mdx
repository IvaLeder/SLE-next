...
<Question question="How do you use a cipher wheel?">
...
- Follow the idea of a shared code from smoke signals to Morse code, binary, and the internet in our [history of communication for kids](/en/history-of-communication-for-kids).
