...
The first friction matches were invented by **John Walker in 1826**, and he began selling them the following year. At that time, they were revolutionary! Before matches, people used to **rub sticks** to create enough heat to create fire on dry leaves or grass. It wasn’t very efficient. Then, people discovered that **striking flint against steel** (or against a mineral called pyrite) creates a spark and they used it to create fire. It was better than rubbing sticks but still tedious and inefficient. So no wonder that matches were such a big deal in the early 19th century.
...
How far will it move? **Newton's second law** states that the acceleration of an object depends on the net force acting upon the object and the mass of the object. So in our rocket’s case, it depends on the **thrust** (how hard the escaping gas pushes, which the **size of the exhaust port** helps decide) and on the **mass of the rocket** itself - the foil, the matchstick and the match heads you packed in.
...
- **Duct tape**. We will use duct tape to decorate our rocket with wings and to attach the launchpad to the surface so it can hold our rocket.
...
3. Gently **take out the wooden skewer from the aluminum foil**. Now we have our aluminum rocket body with the hole left by the wooden skewer. That will be our exhaust port.
...
<Callout type="safety">
This activity is fire, so the rules are not optional. **The adult lights the rocket** \- this is not a step to hand over, however much your child wants it.

- **Outdoors only**, in a clear open space, because the rocket can fly surprisingly far. Never indoors.
- **Keep a bucket or bowl of water right next to you**, and never launch near dry grass, dead leaves, or anything else that catches easily. Skip the whole activity on a hot, dry, windy day.
- **Nobody stands in front of the rocket**, and everyone keeps their distance. Never lean over a rocket on the launchpad.
- **If a rocket doesn't fire, leave it alone.** Don't lean over it and don't try to light it again - wait a few minutes, then douse it in water before touching it.
- The rocket is **very hot right after launch**, so let it cool before picking it up.
</Callout>
...
- [Where do we live in the Universe?](/en/where-do-we-live-in-the-universe) to follow a real rocket's possible address from Earth to the Milky Way and the observable Universe.
