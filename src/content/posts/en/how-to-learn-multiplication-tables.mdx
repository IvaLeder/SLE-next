...
heroAlt: "A child arranging colourful counters into a 7 by 8 array beside a multiplication chart with easy fact families and mirror facts crossed out"
draft: true
previewToken: "f640f448eb138679a0651ef6cb2dc690"
---

Put a blank 1 to 10 multiplication chart in front of a child and it looks like a wall of **100 answers**. No wonder “learn your times tables” can sound like “memorise a small phone book”.
...
<ActivityInfo age="7+" time="10 min" difficulty="Easy" mess="None" supervision="no" />
...
In this guide, **3 × 4 means 3 equal groups of 4**. The total is 12.
...
Easy facts are not filler. They are anchors for working out the harder ones. Start with ×0, ×1, ×10, ×2 and ×5, in roughly that order, then add the mirror versions.
...
### Shortcut 4: For ×10, use place value
...
That is 6 doubled three times. For children who find three steps hard to hold in working memory, use a nearby ten instead: **8 × 6 = 10 × 6 − 2 × 6 = 60 − 12 = 48**. Both routes are correct; use the one that feels lighter.
...
### Minutes 9–10: Mix and finish well
...
- [Assisting Students Struggling with Mathematics: Intervention in the Elementary Grades, What Works Clearinghouse](https://ies.ed.gov/ncee/wwc/practiceguide/26) - evidence-based recommendations on systematic instruction, mathematical language, representations, number lines, word problems and fluency practice.

Once multiplication starts looking like a network of related facts, other parts of mathematics open up. Use the same array to investigate [prime numbers and factor rectangles](/en/prime-numbers-for-kids), make equal parts visible with [fractions and LEGO](/en/how-to-learn-fractions-fun-easy-way), or explore how doubling can solve the [Tower of Hanoi](/en/make-and-solve-tower-of-hanoi).
