...
If all of these activities are too easy for your child, we recommend you check  [How to learn Fractions fun and easy way](/en/how-to-learn-fractions-fun-easy-way/) activity. If you are interested in [Number Pi (π)](/en/explore-number-pi-π/), read the comprehensive article and learn all about that mysterious number. How about making your own [cipher wheel](/en/how-to-make-cipher-wheel/)? And for those “lost in time”, be sure to check [how to make a cardboard clock and learn time](/make-cardboard-clock-learn-tell-time).
