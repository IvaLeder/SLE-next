...
So this wonder week is number 9 and it’s called The world of **principles**. Ominous. It occurs **around 64 weeks of age** or translated 14.8 months. We described all the leaps, from the first to the last, in our [guide to developmental leaps](/en/developmental-leaps), and our [leap calculator](/en/tools/developmental-leap-calculator) will tell you exactly when each one is due for your child. What can you expect? The way we notice wonder weeks is by sudden **sleep** issues. 
