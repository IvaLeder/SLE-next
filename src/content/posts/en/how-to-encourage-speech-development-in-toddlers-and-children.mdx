...
Mother and son reading a picture book together, early shared reading to encourage speech development">
  Books work from day one: just turning pages and talking about pictures counts.
</Figure>
...
<Figure src="/images/posts/Avoid-Screen-time.jpg" alt="Papercut illustration of a tablet with a clock on its screen and a golden path leading away to a book and a toy block - trading screen time for real play and talk">
  Around age two, keep screen time under 30 minutes a day.
</Figure>
...
The American Academy of Pediatrics recommends no screen time before 18 months (video calls with family are the exception), and for ages 2 to 5 at most one hour a day of high-quality content, watched together with you. Our own approach is a bit stricter - treat that as our preference, not a prescription.
</Callout>
...
<Figure src="/images/posts/Boy-and-mother-playing-with-blocks.jpg" alt="Papercut illustration of a girl building with blocks, while parent watches without interfering, offering help only when the child asks for it">
  Offer help, but wait for the child to ask for it.
</Figure>
