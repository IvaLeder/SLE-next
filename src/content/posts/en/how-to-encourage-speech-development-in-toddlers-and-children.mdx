...
translationKey: speech-development-tips
lang: en
slug: how-to-encourage-speech-development-in-toddlers-and-children
subtitle: >-
  Speech. The ultimate way of communication. We can’t wait for the time when our
  toddler will start using words instead of, often frustrating, nonverbal
  attempts at communication. But there is a lot we can do, from the earliest age
  to encourage speech development and language skills. So let’s talk about
  things we can do to speed up the speech development in toddlers and children.
description: >-
  Learn how to encourage speech and language development in children from the
  earliest age. Find best practices and what to avoid in one place.
date: '2020-09-11'
dateModified: '2026-07-15'
author: Vedran Leder
coverImage: >-
  /images/posts/How-to-Encourage-Speech-Development-in-Toddlers-and-Children-Cover-Image-1.jpg
heroAlt: "Papercut illustration of three speech bubbles filled with hearts, linked by a golden thread - encouraging speech development in toddlers and children"
categories:
  - Psychology
tags:
  - child-development
  - parenting
---
Parents like to look at the growth of their little ones through the set of milestones. First, we wait when the newborn will be able to turn on the belly, then sit, crawl, walk... And then comes the time around a year and a half when we wait for that, probably one of the most important milestones - **talking**!

Sometimes, that waiting can be frustrating, we may start to worry and compare our child's progress to others. But as with any milestone, there are variations of "normal" development. That doesn’t mean we should ignore whole idea of encouraging speech development. We can do a lot to support our child to start using words and communicating with speech.

Also, we shouldn't wait for toddlerhood to start. There are many **activities and games** we can use, almost from the day of the birth (some say even sooner), to speed up and prepare our child for this important skill - **using words and communicating with speech**.

So let’s take a look at some things we can do to boost the speech development of our child.

<YouTube id="iwUsDssg99s" title="How to Encourage Speech Development in Toddlers and Children"/>
...
<Figure src="/images/posts/Speech-and-Language-milestones-for-babies-toddlers-and-children.jpg" alt="Infographic of speech milestones by age, from first smiles at 2 months to full sentences at 5 years">
  Speech and language milestones from the first coos to full conversations.
</Figure>

There are certain language milestones that we can track to see if the development is "on the track". They help us to identify potential difficulties in speech development.
...
| **18 months old**          | Vocabulary increases and the toddler is able to use from 10 to 20 words. Toddler will start to communicate with words what it wants like “give” or “more”. Some toddlers start combining 2 words like “go there” or “give drink” - that typically arrives anywhere between 18 and 24 months. Also, the toddler recognizes body parts when we name them.                    |
| **2 years old**            | Vocabulary increases even further and the toddler knows more than 50 words. Two-word combinations are expected by now, and some children already move on to 3-word sentences, with words in the correct order. The toddler is able to name body parts, it names pictures in the book when we ask and it starts to use some plurals while talking.                           |
...
| **3 years old**            | Vocabulary is around 1000 words and the child knows their last name. It can tell a story, knows a couple of nursery rhymes, and can sing songs.                                                                                                                                                                              |
...
<Callout type="info" title="When to check with a professional">
Every child has their own pace, but a few boundaries are worth knowing: no babbling by around 12 months, no first words by 16 to 18 months, no two-word combinations by 24 months, speech that even you struggle to understand at age 3, or a loss of language or social skills at any age. With any of these, go directly to your pediatrician or a speech-language pathologist. An early evaluation never hurts, while waiting can cost valuable time.
</Callout>
...
<Figure src="/images/posts/Developing-Speech-Mother-and-son-reading.jpg" alt="Papercut illustration of a mother and a child reading a picture book together - early shared reading to encourage speech development">
  Early shared reading is a powerful tool for speech development.
</Figure>
...
If the toddler says a word that contains errors, like “Hos!” for a House, just agree and **repeat the word properly**. You can say: “Yes, that is a house!” Saying things like “No, we don’t say it like that…” or “We say H O U S E, now you say it again!” won’t help. It can just **develop an aversion** for talking in a child and negatively impact their confidence and connection with you.
...
<Figure src="/images/posts/Offering-choices-as-a-method-of-learning-language.jpg" alt="Papercut illustration of a parent's hand holding out an apple and a banana with a question mark between them - offering simple choices to grow a toddler's vocabulary">
  Offering two choices satisfies the need for control and grows vocabulary.
</Figure>
...
Questions like “Where is your leg?” or “What is this animal?” will further **enhance connections between objects and words**. Keep it light and fun, not an interrogation. And don’t forget to **give the toddler time to answer**. It can take a while for them to process the question and think about the answer.

#### Limit the TV and Screen time as much as possible

Many studies have shown that screen time may have some **negative effects** on development, including **slower speech development**. With two years old, try to limit the screen time to **no more than 30 minutes per day**. Instead of screen time, engage in activities like reading books together and listening to stories, which have a much more positive impact on language development. The **most important factor** in speech development are **face to face interactions** with parents and caregivers, so make sure to prioritize those over screen time.

<Figure src="/images/posts/Avoid-Screen-time.jpg" alt="Papercut illustration of a tablet with a clock on its screen and a golden path leading away to a book and a toy block - trading screen time for real play and talk">
It's good idea to limit children's time in front of the screens. There are many benefits to engaging in real play and conversation instead.
</Figure>
...
<Figure src="/images/posts/Categorization-for-learning-a-language.jpg" alt="Papercut illustration of two baskets, one of fruit and one of animals, linked by golden threads - grouping things into categories to build vocabulary">
  Grouping words into categories makes them easier to recall later.
</Figure>

#### Start using sounds and words with symbolic meaning

Say “**Ouch**!” when you hit yourself, “**Whoops**!” when you spill something by accident, or “**Brrm**, **brrm**” when you see the car.
...
The important thing we should always have at the top of our mind is that we should strive to help the children **take the steps they are ready for**.
...
The first communication young children use is gestures. Always comment by words what they are trying to communicate to you. If child is pointing to something, ask "Do you want the ball?" Check if you are right by asking them to confirm your interpretation, don't assume. This will help them to **connect gestures with words** and **learn the meaning of words**.
...
Grownups love this one. But constantly asking children “What is this?”, “What is that?” can be stressful for children and annoy them. It can also lead to unwanted behaviors ([**tantrums**](/en/challenges-parent-temper-tantrum)). If you know the child already knows some words, avoid asking them again. Repeating the word will come naturally sooner or later in any case.

<Figure src="/images/posts/Avoid-Testing-what-the-child-already-knows.jpg" alt="Papercut illustration of a flower whose blooms are a cluster of question marks, drooping beside a gold heart - constant quizzing overwhelms rather than helps">
  Constant "what is this?" quizzing stresses children more than it teaches.
</Figure>

### Avoid screens and TV

**Avoid screens until the age of 18 months**! After 18 months, toddlers can have some screen time but limit it to **no more than 30 minutes** at the start. And when the child starts to watch something, watch with him and talk later about what you were watching. Families are different and there is no one-size-fits-all approach, but the general rule is that **face-to-face interactions** are much more important than screen time.

<Callout type="info" title="What do official guidelines say?">
The American Academy of Pediatrics recommends no screen time before 18 months (video calls with family are the exception), and for ages 2 to 5 at most one hour a day of high-quality content, watched together with you.
</Callout>
...
<Figure src="/images/posts/Boy-and-mother-playing-with-blocks.jpg" alt="Papercut illustration of a girl building with blocks, while parent watches without interfering, offering help only when the child asks for it">
  Be ready to help when needed, but wait for the child to ask for it.
</Figure>

### Talk about past and future events

You can look at the pictures you took with your child and talk about those times. This will trigger a memory in the child and it will be strongly motivated to express those memories. Also, you can talk about future plans, like trips and what awaits you on the trip. This will create curiosity in the child and it will want to talk about that new, interesting thing that awaits you.

### Teach to say “Thank” you and “Please” by making an example

Forcing the child to say words like “thank you” and “please” won’t make them learn the real meaning of those words. It may even cause some resistance, since it can be humiliating to be forced to say them. A better way is to lead by example and use those words in your household. Social modeling is a powerful tool in teaching children how to communicate and behave in social situations. Children will pick them automatically and start to use when appropriate and more importantly when they actually mean it. Roleplying is also a great way to teach children how to use those words in the right context.

### Avoid electronic toys with sounds

It may seem counterintuitive, but toys that produce sounds like talking dolls or electric piano are actually not good for language development. It is more similar to TV or screen activities than to interactions with other people. These kinds of toys are passive entertainment and there is no effort required to be entertained. It limits the imagination and motivation of a young child while it is passively entertained.

### A note for educators

Group settings are language gold. Narrate routines, expand children's utterances back to them ("Ball!" - "Yes, a big red ball!") and build in real turn-taking through songs and circle games. Keep an eye on the quiet child who communicates only with gestures, and share observations with parents early and kindly. Educators are often the first to spot a delay.
...
- [Your Child’s Cognitive Development](/en/your-childs-cognitive-development) - to learn about different cognitive milestones children reach through growing up.
- [Sensorimotor Activities for Children](/en/sensorimotor-activities-children) - interesting activities and suggestions for improvement of sensorimotor skills.
- [How to Improve Child’s Working Memory](/en/improve-childs-working-memory) - tips and activities for improvement of short term (working) memory.
- [7 Fun Activities to Learn Letters and Numbers](/en/learning-letters-for-preschoolers-activity) - if you are in the learning letters and numbers stage, check these 7 activities you can use and learn while having great fun.
