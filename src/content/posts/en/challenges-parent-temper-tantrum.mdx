...
<Figure src="/images/posts/Challenges-of-being-a-parent-–-Temper-Tantrum-Yelling-at-Child.png" alt="Papercut illustration of a large storm cloud striking a smaller cloud with a lightning bolt as it rains - yelling only pours fuel on an overwhelmed child">
...
<Figure src="/images/posts/Challenges-of-being-a-parent-–-Temper-Tantrum-Stay-Calm.jpg" alt="Papercut illustration of a parent staying calm and close to a child during a temper tantrum, composure as the child's anchor">
...
## A Note for Preschool Teachers and Educators

The same principles work in a group. Tantrums peak at drop-off and transitions, so predictable routines and advance warnings ("after this song, we tidy up") prevent most of them. During an outburst, keep the rest of the group moving, stay low and calm next to the child, and skip the audience-facing lecture. And one message worth passing to parents: a meltdown at pickup usually means the child held it together all day and let it out now when it feels safest.
